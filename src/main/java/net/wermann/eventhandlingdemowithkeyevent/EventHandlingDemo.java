...
public class EventHandlingDemo extends Application {
    ...
    public void start(Stage stage) throws Exception {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/net/wermann/eventhandlingdemowithkeyevent/EventHandling.fxml"));
            Scene scene = new Scene(root, 1024, 768);
            scene.getStylesheets().add(getClass().getResource("/net/wermann/eventhandlingdemowithkeyevent/application.css").toExternalForm());
